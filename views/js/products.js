  	...
  	if(image["type"] != "image/jpeg" && image["type"] != "image/png"){
  		...
  		$(".newImage").val("");
  		 ...
  		 swal({
		      ...
		      text: "A imagem deve estar no formato JPG o PNG!",
		      type: "error",
  		...
  		$(".newImage").val("");
  		 ...
  		 swal({
		      title: "Erro ao carregar a imagem",
		      text: "A imagem não deve ter mais de 2MB!",
		      type: "error",
		      confirmButtonText: "Fechar"
		    });
...
$(".productsTable tbody").on("click", "button.btnDeleteProduct", function(){
	...
	swal({
		...
		title: 'Tem certeza de que deseja excluir o produto?',
		text: "Se você não tem certeza, pode cancelar esta ação!",
		type: 'warning',
