     ...
     $.ajax({
     	...
     	url:"ajax/products.ajax.php",
      	...
      	success:function(answer){
          	...
          	/*=============================================
          	EVITE ADICIONAR O PRODUTO QUANDO SEU ESTOQUE ESTIVER ZERO
          	=============================================*/
			/* GRECAO ESTEVE AKI GRECAO ESTEVE AKIS */
...
/*=============================================
REMOVER PRODUTOS DO BOTÃO VENDA E RECUPERAR
=============================================*/
...
$(".saleForm").on("click", "button.removeProduct", function(){
	...
	/*=============================================
	ARMAZENAR NO LOCALSTORAGE O ID DO PRODUTO QUE QUEREMOS EXCLUIR
	=============================================*/
...
$(".saleForm").on("change", "input.newProductQuantity", function(){
	...
	if(Number($(this).val()) > Number($(this).attr("stock"))){
		...
		/*=============================================
		SE A QUANTIDADE FOR SUPERIOR AO VALOR DE ESTOQUE DEFINIR VALORES INICIAIS
		=============================================*/
		...
		swal({
	      title: "A quantidade é mais do que o seu estoque",
	      text: "Há apenas"+$(this).attr("stock")+" unidades!",
	      type: "error",
	      confirmButtonText: "Fechar"
	    });
		 ...
		 $(this).parent().parent().parent().children('.paymentMethodBoxes').html(
		 	...
		 	'<div class="col-xs-6" style="padding-left:0px">'+
                ...
                '<div class="input-group">'+
                  ...
                  '<input type="number" min="0" class="form-control" id="newTransactionCode" placeholder="Código de transação"  required>'+
...
$(".tables").on("click", ".btnDeleteSale", function(){
  ...
  swal({
        title: 'Tem certeza de que deseja excluir isso?',
        text: "Se não estiver, pode cancelar!",
        type: 'warning',
...
$('#daterange-btn').daterangepicker(
  ...
  function (start, end) {
    ...
    var initialDate = start.format('DD-MM-YYYY');
