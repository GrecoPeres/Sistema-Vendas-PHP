...
class ControllerSales{
	...
	static public function ctrCreateSale(){
		...
		if(isset($_POST["newSale"])){
			...
			/*=============================================
			ATUALIZAR AS COMPRAS DO CLIENTE E REDUZIR O ESTOQUE E AUMENTAR AS VENDAS DO PRODUTO -- STRONKS TÁ ? KKKK
			=============================================*/
			...
			if($answer == "ok"){
				...
				swal({
					  type: "success",
					  title: "A venda foi adicionada com sucesso",
	...
	static public function ctrEditSale(){
		...
		if(isset($_POST["editSale"])){
			...
			/*=============================================
			FORMATAR TABELAS DE PRODUTOS E CLIENTES
			=============================================*/
			$table = "sales";
			...
			/*=============================================
			VERIFICO SE HÁ ALGUMA PROMOÇÃO EDITADA
			=============================================*/
			...
			if($productChange){
				...
				/* --GRECAO ESTEVE AKI GRECAO ESTEVE AKIS-- */
				/*=============================================
				ATUALIZAR AS COMPRAS DO CLIENTE E REDUZIR O ESTOQUE E AUMENTAR AS VENDAS DE PRODUTOS --  STRONKS DNV TÁ ? KSAKSKA
				=============================================*/
			...
			if($answer == "ok"){
				...
				swal({
					  type: "success",
					  title: "A venda foi editada corretamente",
					  showConfirmButton: true,
					  confirmButtonText: "Fechar"
					  }).then((result) => {
								if (result.value) {
	...
	static public function ctrDeleteSale(){
		...
		if(isset($_GET["idSale"])){
			...
			if($answer == "ok"){
				...
				swal({
					  type: "success",
					  title: "A venda foi excluída com sucesso",
					  showConfirmButton: true,
					  confirmButtonText: "Fechar",
	...
	public function ctrDownloadReport(){
		...
		if(isset($_GET["report"])){
			...
			echo utf8_decode("<table border='0'> 
					...
					<td style='font-weight:bold; border:1px solid #eee;'>Quantidade</td>
					<td style='font-weight:bold; border:1px solid #eee;'>Produtos</td>
					<td style='font-weight:bold; border:1px solid #eee;'>Juros</td>
					<td style='font-weight:bold; border:1px solid #eee;'>Preço Líquido</td>		
					<td style='font-weight:bold; border:1px solid #eee;'>TOTAL</td>		
					<td style='font-weight:bold; border:1px solid #eee;'>FORMA DE PAGAMENTO</td	
					<td style='font-weight:bold; border:1px solid #eee;'>DATA</td>		
					</tr>");
